...
public class ConsultaService implements  IConsultaService{
    ...
    public Consulta getConsulta(){
        ...
        if(consultas==null) {
            consultas = (Consulta) jdbcTemplate.queryForObject("SELECT SQL_NOTIFICADO, SQL_RECHAZADO, SQL_ACTUALIZAR, SQL_BUSCAR_CIUDADANO FROM CP_TBL_CONSULTA_JOB  WHERE ID_CONSULTA = 1", new BeanPropertyRowMapper(Consulta.class));
